...
# ==========================================
# 1. עיצוב CSS מלא למחיקת המרווחים של Streamlit
# ==========================================
st.markdown("""
<style>
/* איפוס מוחלט של כל המרווחים כדי שהצבע ייגע בקצוות המסך */
...
<div style="position: relative; width: 100%; min-height: 100vh; background-color: #f0f2f6; padding-bottom: 80px;">
    ...
    <!-- גוף האפליקציה (עולה על הרקע הכחול) -->
    <div style="margin-top: -30px; padding: 0 15px; position: relative; z-index: 10;">
        
        <div style="text-align: center; color: #0a4682; font-size: 20px; font-weight: 900; margin-bottom: 15px;">
            אזור אישי
        </div>
        ...
        <div style="background: white; border-radius: 16px; padding: 20px; margin-bottom: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.03);">
            ...
            <div style="width: 100%; text-align: center; border: 1.5px solid #0a4682; color: #0a4682; padding: 10px; border-radius: 10px; font-weight: 700; font-size: 14px;">
                צפייה בתלושים נוספים
            </div>
        </div>
