...
if not st.session_state.app_loaded:
    ...
    # מעטפת ראשית
    st.markdown('<div style="background-color: #f0f2f6; padding-bottom: 110px; width: 100%; direction: rtl; font-family: \'Assistant\', sans-serif;">', unsafe_allow_html=True)
    ...
    # 3. תפריט ניווט תחתון וסגירת מעטפת
    st.markdown("""
