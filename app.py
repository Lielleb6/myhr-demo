...
<style>
    * { box-sizing: border-box; }
    html, body { margin: 0; padding: 0; background-color: #f0f2f6; font-family: 'Assistant', sans-serif; overflow-x: hidden; }
    ...
    #splash {
        ...
        background: linear-gradient(180deg, #0a4682 0%, #052c54 100%);
...
<div style="background-color: #f0f2f6; padding-bottom: 120px; width: 100%; max-width: 480px; margin: 0 auto; min-height: 100vh; direction: rtl;">
    ...
    <div style="padding: 20px 15px 0 15px; position: relative; z-index: 10;">
        ...
        <div class="card">
            ...
            <div style="width: 100%; text-align: center; border: 1.5px solid #0a4682; color: #0a4682; padding: 10px; border-radius: 10px; font-weight: 700; font-size: 15px; cursor: pointer;">צפייה בתלוש האחרון</div>
        </div>
    </div>
