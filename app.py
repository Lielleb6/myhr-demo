...
if not st.session_state.app_loaded:
    with placeholder.container():
        ...
        <style>
        html, body { margin: 0 !important; padding: 0 !important; background-color: #f0f2f6; overflow-x: hidden; }
        .block-container, div[data-testid="stAppViewBlockContainer"] { padding: 0 !important; margin: 0 !important; max-width: 100% !important; }
